...
import { Loader2, Sparkles, FileText, Users, Eye, EyeOff } from "lucide-react";
          ...
          <div className="bg-white border border-gray-200 rounded-[24px] p-6 md:p-7 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-11 rounded-xl bg-violet-600 hover:bg-violet-700 text-white text-sm font-semibold transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
